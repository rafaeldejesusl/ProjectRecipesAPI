...
public class TestTestCreate
{
    ...
    [Trait("Category", "Implemente a função Create e seus testes")]
    [Theory]
    [MemberData(nameof(RecipeServiceTestData))]
    public void TestSucessCreate(Recipe entryRecipe, List<Recipe> expected)
    {
        TestRecipesControllerCreate instance = new();
        Action act = () => instance.TestCreate(entryRecipe, expected);
    ...
    public void TestFailCreate(Recipe entryRecipe, List<Recipe> expected)
    {
        TestRecipesControllerCreate instance = new();
        Action act = () => instance.TestCreate(entryRecipe, expected);
