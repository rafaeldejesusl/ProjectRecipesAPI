...
public class TestTestDelete
{
    ...
    [Trait("Category", "Implemente a função Delete e seus testes")]
    [Theory]
    [MemberData(nameof(RecipeServiceTestData))]
    public void TestSucessDelete(string entryName, List<Recipe> expected)
    {
        TestRecipesControllerDelete instance = new();
        Action act = () => instance.TestDelete(entryName, expected);
    ...
    public void TestFailDelete(string entryName, List<Recipe> expected)
    {
        TestRecipesControllerDelete instance = new();
        Action act = () => instance.TestDelete(entryName, expected);
